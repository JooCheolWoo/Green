        ...
        <div id="container">
            <div class="main">
				...
				<div class="board_list">
					<div id="content">
						<h2>[${dictionary.category}][${dictionary.subCategoryD}] ${dictionary.title}</h2>
						<p>글쓴이: ${dictionary.writer} | 작성날짜: ${dictionary.createdAt.toLocalDate()} ${dictionary.createdAt.toLocalTime()} | 조회수: ${dictionary.viewCount + 1} | 추천수: ${dictionary.likeCount}</p>
						<hr>
